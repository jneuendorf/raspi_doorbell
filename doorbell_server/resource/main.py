# https://github.com/Happypig123123/dbell
...
# loops forever till keyboard interupt (ctr + C)
while True:
    if not GPIO.input(Button):  # when button pressed:
        ...
        print("Email")  # email
        emailcommand = (
            'python3 IOTNOTIFY2.py "Someone is at the door"'
            + ' "photos/'
            + now
            + '.jpg"'
        )
